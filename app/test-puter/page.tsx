...
export default function TestPuterPage() {
  ...
  const [testMessage, setTestMessage] = useState(
    "Hey tell me what you want to write about today?"
  );
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-slate-900 dark:text-white mb-4">
            Helping Author with Power of AI
          </h1>
          <p className="text-slate-600 dark:text-slate-300">
            Putting your thoughts to accelerate
          </p>
        </div>
        ...
        <div className="grid gap-6">
                ...
                {loading ? (
                  ...
                  <>
                    ...
                    <span className="text-green-600">
                      Give us ideas will try to help with that
                    </span>
                    <Badge
                      variant="outline"
          ...
          <Card>
            <CardHeader>
              <CardTitle>Your authors chatbot</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">
                  Tell me the words you want to spread and write abount
                </label>
                <Textarea
                  value={testMessage}
              ...
              {testResponse && (
                <div className="mt-4">
                  ...
                  <div className="p-4 bg-slate-50 dark:bg-slate-800 rounded-lg border">
                    <pre className="whitespace-pre-wrap text-sm text-slate-900 dark:text-white">
                      {testResponse}
                    </pre>
                  </div>
                </div>
            ...
            <CardContent>
              <div className="space-y-2 text-sm">
                {/* <div className="flex justify-between">
                  ...
                  <Badge variant={sdkLoaded ? "default" : "destructive"}>
                    {sdkLoaded ? "Yes" : "No"}
                  </Badge>
                </div> */}
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <Badge
                    variant={
                      typeof window !== "undefined" && window.puter?.ai?.chat
                        ? "default"
                        : "destructive"
                    }
                  >
